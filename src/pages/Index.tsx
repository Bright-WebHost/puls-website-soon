...
const Index = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-[#01461F] via-[#01461F] to-[#01461F]">
        ...
        <div className="text-center max-w-xs sm:max-w-md md:max-w-2xl lg:max-w-4xl mx-auto animate-fade-in-up">
          ...
          <div className="mb-6 sm:mb-8 inline-block animate-float-gentle">
            <div className="relative transform-gpu preserve-3d">
              ...
              <Sparkles className="w-3 h-3 sm:w-4 sm:h-4 md:w-6 md:h-6 text-yellow-300 absolute -bottom-1 -left-1 animate-twinkle"  style={{display:'none'}}/>
            </div>
          </div>
